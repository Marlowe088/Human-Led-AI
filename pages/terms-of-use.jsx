...
const SECTIONS = [
  {
    ...
    html: `<p>These Terms of Use explain how this website, its content, diagnostics, products, and services may be used. By using this website, completing the Purpose Path&trade; Diagnostic, purchasing a product, or accessing any content provided through this site, you agree to these terms.</p>`,
  },
  {
    number: 2,
    title: 'Who We Are.',
  ...
  },
  {
    ...
    html: `<p>manojtailor.com may provide: written pages and content, the Purpose Path&trade; Diagnostic, the Meaning Map&trade; digital report, downloadable materials, and future digital products or services. All products are provided digitally unless clearly stated otherwise.</p>`,
  },
  {
    number: 5,
    title: 'What This Is &mdash; And What It Is Not.',
  ...
  },
  {
    ...
    html: `<p>You agree not to use this website, the diagnostic, or the Meaning Map&trade; as a substitute for your own judgment or for professional advice where required. Nothing on this website guarantees a specific outcome.</p>`,
  },
  {
    number: 7,
    title: 'The Purpose Path&trade; Diagnostic.',
  ...
  },
  {
    ...
    html: `<p>All content on this website &mdash; including the Meaning Map&trade;, the Purpose Path&trade; Diagnostic, the Five Purpose Paths&trade;, and related materials &mdash; is owned by Manoj Tailor or licensed for use, and protected by copyright and applicable law. You may not reproduce, sell, distribute, or train AI systems on this material without written permission.</p>`,
  },
  {
    number: 11,
    title: 'Email Content.',
    html: `<p>If you opt in to receive emails through the diagnostic or a purchase, you agree to receive emails from Manoj Tailor related to your result, your Meaning Map&trade;, and occasional related content. You can unsubscribe at any time. You may forward an occasional email to someone you think would benefit; you may not reproduce, republish, or commercially distribute email content without permission.</p>`,
  },
  {
    number: 12,
    title: 'Payments and Digital Access.',
    html: `<p>Prices are shown clearly before purchase, in GBP. By purchasing, you agree to pay the stated price, provide accurate information, and receive digital access to the Meaning Map&trade; report. Payment is processed by Stripe; we do not directly store your full card details. Access is provided digitally after purchase.</p>`,
  },
  {
    number: 13,
    title: 'Digital Content and Cancellation Rights.',
    html: `<p>The Meaning Map&trade; report may be made available shortly after purchase. If you&rsquo;re a UK or EU consumer, you have a 14-day cancellation right for online purchases &mdash; but specific rules apply once digital content access has begun, particularly where you&rsquo;ve expressly agreed to immediate access. Nothing in these terms removes or reduces your statutory rights under applicable consumer law. Checkout will clearly state whether access begins immediately and whether this affects your cancellation right.</p>`,
  },
  {
    number: 14,
    title: 'Refunds.',
    html: `<p>The Meaning Map&trade; specific guarantee (14 days, reply to the delivery email for a full refund) is described on the offer page and applies as stated. Beyond that: refund requests must be made within the stated period, the report must not have been shared or redistributed, and we may ask for reasonable information to process the request. If a product is faulty or not as described, your statutory legal rights remain unaffected. Approved refunds go back to the original payment method.</p>`,
  },
  {
    number: 15,
    title: 'Product-Specific Guarantee.',
    html: `<p>The Meaning Map&trade; includes a specific guarantee, detailed on its offer page: if the report doesn&rsquo;t accurately describe you, you can request a full refund within 14 days by replying to the delivery email. This guarantee applies only to the Meaning Map&trade; and does not extend to other products or services unless separately stated. Statutory consumer rights remain unaffected.</p>`,
  },
  {
    number: 16,
  ...
  },
  {
    number: 17,
    title: 'No Guarantees.',
    html: `<p>The Meaning Map&trade; and diagnostic are designed to support reflection and orientation. No specific outcome is guaranteed &mdash; not finding your purpose, achieving a particular decision, or any specific life, career, or emotional result. Outcomes depend on your own context, choices, and actions.</p>`,
  },
  {
    number: 18,
  ...
  },
  {
    ...
    html: `<p>To the fullest extent permitted by law, Manoj Tailor and manojtailor.com are not liable for indirect or consequential loss, decisions made based on website content or the Meaning Map&trade;, losses from third-party services, or website downtime. Nothing here excludes liability that cannot legally be excluded under the laws of England and Wales, including for death or personal injury caused by negligence, fraud, or statutory consumer rights that cannot be excluded.</p>`,
  },
  {
    number: 23,
    title: 'Indemnity.',
